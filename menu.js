...
const MENU = {
  ...
  'sandwiches': [
    ...
    { id: 'sw8', name: 'Jambon-Fromage',  img: 'jambon_fromage.png',       desc: 'Ham, Emmental cheese, butter.',                     price: 10.20 },
    { id: 'sw9', name: 'Jambon-Fromage Gourmet',  img: 'jambon_fromage_gourmet.png',       desc: 'Jambon-Fromage with Lettuce, Tomatoes and Onions.',                     price: 13.00 },
    { id: 'sw10', name: 'Thon Maison',                       img: 'thon_maison.png',          desc: 'Homemade tuna rillette.',                           price: 15.00 },
    { id: 'sw11', name: 'Briard',                            img: 'briard.png',               desc: 'Brie, arugula, prunes, balsamic vinegar.',          price: 15.00 },
  ],
